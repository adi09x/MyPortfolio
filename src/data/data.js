...
export const data = [
  {
    id: 1,
    img: 'https://i.postimg.cc/XJ8tLxx3/ECom-For-Artisans.png',
  ...
  {
    id: 2,
    img: 'https://i.postimg.cc/gjGmkntc/Traveller-Landing-Page.png',
    title: "Holiday Landers",
    link: "",
    desc:"",
  ...
  {
    id: 3,
    img: 'https://i.postimg.cc/cJKqsQsB/Restaurant-X.png',
    title: "Restaurant X",
    desc: "",
  ...
  {
    id: 4,
    img: 'https://i.postimg.cc/RVmywrCJ/Digital-Certificate.png',
    title: "Gov-Certify",
    desc: "",
    large_desc:"Blockchain-Based Certificate Generation and Verification System, represents a pioneering solution designed to reshape the landscape of certificate management. In a world that relies heavily on paper documents and traditional verification methods, our system leverages the power of blockchain technology to offer a more secure, efficient, and transparent approach to certificate issuance and validation.",
    link: "",
    git: "",
  }
