      ...
      <div className=" container mx-auto pt-5 h-[750px] md:h-[100vh] md:flex-col-reverse sm:h-[780px]  flex sm:pt-0 ">
        <div className=" left mt-4 md:mt-0 flex-1 flex flex-col justify-center gap-5 w-1/2 md:w-full md:py-2 sm:py-0">
          <div className="info w-fit flex flex-col items-start justify-center gap-3 sm:gap-2">
            ...
            >
              Designing, coding, and creating the future.
            </p>
          </div>
          ...
          <div className="icons flex mt-5">
            ...
            >
              <li>
                <a href="https://github.com/adi09x">
                  {" "}
                  <AiFillGithub className=" h-[1.8rem] w-[1.8rem] text-xl hover:scale-125" />{" "}
                </a>
              </li>
              <li>
                <a href="https://www.linkedin.com/in/aditya-jadhav-106a01241/">
                  {" "}
                  <FaLinkedinIn className=" h-[1.8rem] w-[1.8rem] text-xl hover:scale-125 " />{" "}
                </a>
              </li>
              <li>
                <a href="https://www.instagram.com/adii.09x/">
                  {" "}
              ...
              <li>
                <a href="https://twitter.com/AdityaJ7094">
                  {" "}
        ...
        <div className="relative flex h-[111%] w-full items-center sm:items-end ">
          <img
            data-aos="fade-up"
            className="max-w-full h-[90%] md:max-h-[150%] md:m-auto sm:m-0"
